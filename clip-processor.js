...
var ClipActions = (function () {
    ...
    ClipActions.DoConstrain = function (clipToMutate, clipToSourceFrom, options) {
    ...
    ClipActions.DoInterleave = function (clipToMutate, clipToSourceFrom, options) {
