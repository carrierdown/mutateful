...
public class OptionsTest
{
    class OptionsClassOne
    {
        ...
        [OptionInfo(min: 1, max: 100)] public int IntValue { get; set; }
    }
    ...
    {
        [OptionInfo(min: 0f, max: 1f)] public decimal[] DecimalValues { get; set; }

        [OptionInfo(min: 1, max: 100)] public int[] IntValues { get; set; }
    }
    ...
    public void TestValues()
    {
        ...
        var (success, msg) =
            OptionParser.TryParseOptions(new Command { Options = options }, out OptionsClassOne parsedOptions);
    ...
    public void TestMinMaxValues()
    {
        ...
        var (success, _) =
            OptionParser.TryParseOptions(new Command { Options = options }, out OptionsClassThree parsedOptions);
    ...
    public void TestListValues()
    {
        ...
        {
            new Token(TokenType.Number, "14", 0), new Token(TokenType.Number, "2", 0),
            new Token(TokenType.Number, "900", 0)
        };
        var (success, msg) =
            OptionParser.TryParseOptions(new Command { Options = options }, out OptionsClassTwo parsedOptions);
