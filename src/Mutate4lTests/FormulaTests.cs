...
namespace Mutate4lTests
{
    ...
    public class FormulaTests
    {
        ...
        // Test generated by mutate4l from formula: [<b1>0] skip 2 4 3
        [TestMethod]
        public void TestSkipBySpecifiedValues()
        {
            byte[] input =
            {
                14, 1, 0, 1, 1, 0, 0, 0, 128, 64, 1, 16, 0, 60, 0, 0, 0, 0, 117, 129, 69, 62, 100, 61, 0, 0, 128, 62, 0, 0, 128,
                62, 100, 62, 0, 0, 0, 63, 165, 57, 69, 62, 100, 63, 0, 0, 64, 63, 103, 232, 39, 62, 100, 64, 0, 0, 128, 63, 0, 0,
                128, 62, 100, 65, 0, 0, 160, 63, 207, 168, 173, 61, 100, 66, 0, 0, 192, 63, 0, 0, 128, 62, 100, 67, 0, 0, 224, 63,
                126, 20, 46, 62, 100, 68, 0, 0, 0, 64, 0, 0, 128, 62, 100, 69, 0, 0, 16, 64, 140, 29, 141, 61, 100, 70, 0, 0, 32,
                64, 0, 0, 128, 62, 100, 71, 0, 0, 48, 64, 169, 189, 56, 62, 100, 72, 0, 0, 64, 64, 0, 0, 128, 62, 100, 73, 0, 0,
                80, 64, 220, 168, 76, 62, 100, 74, 0, 0, 96, 64, 0, 0, 128, 62, 100, 75, 0, 0, 112, 64, 0, 0, 128, 62, 100, 91,
                60, 98, 49, 62, 48, 93, 32, 115, 107, 105, 112, 32, 50, 32, 52, 32, 51
            };
            byte[] output =
            {
                14, 1, 0, 0, 128, 64, 1, 16, 0, 60, 0, 0, 0, 0, 120, 129, 69, 62, 100, 61, 0, 0, 128, 62, 0, 0, 128, 62, 100, 63,
                0, 0, 0, 63, 104, 232, 39, 62, 100, 64, 0, 0, 64, 63, 0, 0, 128, 62, 100, 65, 0, 0, 128, 63, 207, 168, 173, 61,
                100, 66, 0, 0, 160, 63, 0, 0, 128, 62, 100, 68, 0, 0, 192, 63, 0, 0, 128, 62, 100, 69, 0, 0, 224, 63, 140, 29,
                141, 61, 100, 70, 0, 0, 0, 64, 0, 0, 128, 62, 100, 72, 0, 0, 16, 64, 0, 0, 128, 62, 100, 73, 0, 0, 32, 64, 220,
                168, 76, 62, 100, 75, 0, 0, 48, 64, 0, 0, 128, 62, 100, 60, 0, 0, 64, 64, 120, 129, 69, 62, 100, 61, 0, 0, 80, 64,
                0, 0, 128, 62, 100, 62, 0, 0, 96, 64, 164, 57, 69, 62, 100, 64, 0, 0, 112, 64, 0, 0, 128, 62, 100
            };
