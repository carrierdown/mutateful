...
namespace Mutate4l.Core
{
    ...
    {
        // might be an idea to have an empty ClipSlot which is what you get by default if asking for an undefined clipreference. This also means that current state for a delete command could be simple ClipSlot.Empty.
